...
/**
 * Created by Millochka on 3/16/17.
 */
...
public class PendingReviewFragment extends Fragment {
    ...
    @BindView(R.id.pending_review_challenges)
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mPendingReviewAdapter = new PendingReviewAdapter();
        mPendingReviewAdapter.setmListener(mListener);
    ...
    public void setmListener(CreatedChallengeListener mListener) {

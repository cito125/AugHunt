...
import com.example.andresarango.aughunt.profile.viewpager.created.CreatedChallengeViewHolder;
...
class PendingChallengeHolder extends CreatedChallengeViewHolder {
    @BindView(R.id.iv_created_challenge_image)
    ImageView mChallengeImageIv;
    //    @BindView(R.id.tv_created_challenge_hint) TextView mHintTv;
    @BindView(R.id.tv_created_challenge_players)
...
//    @BindView(R.id.tv_hint) TextView mHint;
    ...
    public PendingChallengeHolder(View itemView) {
        super(itemView);

...
public class AugmentedRealityCreateChallengeCameraActivity extends AppCompatActivity implements
    ...
    public void run(LocationResult locationResult) {
        ...
        uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                e.printStackTrace();
                progressDialog.dismiss();
                Toast.makeText(AugmentedRealityCreateChallengeCameraActivity.this, "Failed to save image.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void requestPermission() {
        int locationPermission = ContextCompat.checkSelfPermission(AugmentedRealityCreateChallengeCameraActivity.this, Manifest.permission.ACCESS_FINE_LOCATION);
        ...
        if (locationPermissionIsNotGranted) {
            ActivityCompat.requestPermissions(AugmentedRealityCreateChallengeCameraActivity.this,
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener onClickListener) {
        new AlertDialog.Builder(AugmentedRealityCreateChallengeCameraActivity.this)
                .setMessage(message)
